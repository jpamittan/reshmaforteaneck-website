...
import { CheckIcon, CalendarIcon } from "@heroicons/vue/20/solid";
...
const timeline = [
    ...
    {
        id: 2,
        content: "Voter Registration Deadline",
        date: "Oct 19",
        datetime: "2024-10-19",
        icon: CalendarIcon,
        iconBackground: "bg-gray-500",
    ...
    {
        id: 4,
        content: "Deadline to Apply for a Mail-In Ballot",
        date: "Nov 1",
        datetime: "2024-11-01",
        icon: CalendarIcon,
        iconBackground: "bg-gray-500",
    ...
    {
        id: 5,
        content: "Deadline for mail in ballots by 8:00pm on Election Day",
        date: "Nov 5",
        datetime: "2024-11-05",
        icon: CalendarIcon,
        iconBackground: "bg-gray-500",
...
<template>
    <AppLayout>
        <div class="flow-root p-8 lg:px-40">
